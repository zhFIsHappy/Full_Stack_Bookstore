...
//
//    @Override
//    public List<String> findByNameSpecified(String name) {
//        List<String> categoryIdAndName = new ArrayList<>();
//        Category category = null;
//        try (Connection connection = JdbcUtils.getConnection();
//             PreparedStatement statement = connection.prepareStatement(FIND_BY_NAME_SQL)) {
//            statement.setString(1, name);
...
//                    categoryIdAndName.add(category.getName());
//                    categoryIdAndName.add(id);
//                }
//            }
//        } catch (SQLException e) {
//            throw new BookstoreQueryDbException("Encountered a problem finding category " + name, e);
